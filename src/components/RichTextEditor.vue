<!-- 19-1.1 下载安装wangEditor及vue依赖包:-->
<!-- npm install wangEditor --save  -->
<!-- npm install  @wangeditor/editor-for-vue@next -->
<!-- 19-1.2 创建component/RichTextEditor.vue封装富文本编辑器 -->
<template>
  <div class="rich-text-editor">
    <!-- 富文本编辑器 -->
    <div class="editor-container">
      <!-- 19-1.4 工具栏editor-toolbar,绑定editorRef,配置toolbarConfig -->
      <WangToolbar 
        :editor="editorRef" 
      ...
      />
      <!-- 19-1.5 编辑器wang-editor,绑定content,配置editorConfig -->
      <WangEditor
        v-model="content"
...
// 19-1.3 引入wangEditor的工具栏和编辑器及样式
